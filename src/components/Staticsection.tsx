...
const Staticsection = () => {
  ...
  // Intersection Observer bach ndetecti fash section yban
  useEffect(() => {
  ...
  return (
    <section
      ref={sectionRef}
      className=" bg-[#FFF8F0] py-16 relative"
    >
      ...
      <div className="container mx-auto overflow-x-auto">
        <div className="flex gap-8 min-w-max justify-center">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="w-64 flex-shrink-0 bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 text-center"
            >
              <h2
